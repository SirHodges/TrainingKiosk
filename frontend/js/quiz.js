...
import { startQuiz as apiStartQuiz, submitAnswer, skipQuestion, checkTopScore, submitScore, getLeaderboard } from './api.js?v=4.6';
import { playRight, playWrong } from './audio.js?v=4.6';
import { registerFocusables, clearFocusables } from './navigation.js?v=4.6';
import { startBinding, endSession } from './gamepad.js?v=4.6';
import { displayScoresWithPlaceholder, loadLeaderboard } from './leaderboard.js?v=4.6';
