import { MAP_WIDTH, MAP_HEIGHT, latLonToXY, xyToLatLon, calculatePoints, calculateDistance, calculateZoomViewBox } from './geogame_math.js?v=4.2';
import { initCalibration, exitCalibration } from './geogame_calibration.js?v=4.2';
import { startBinding, getGamepadForPlayer } from './gamepad.js?v=4.2';
